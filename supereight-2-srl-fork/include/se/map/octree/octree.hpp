...
class Octree {
   ...
   */
    ...
    /** \brief The minimum voxel coordinates of the AABB of the map's updated regions.
     */
    const Eigen::Array3i& aabbMin() const;

    /** \brief The maximum voxel coordinates of the AABB of the map's updated regions.
     */
    const Eigen::Array3i& aabbMax() const;

    /** \brief Update the map's updated region AABB with voxel_coord.
     */
    void aabbUpdate(const Eigen::Vector3i& voxel_coord);
    ...
    Eigen::Array3i aabb_min_;
    Eigen::Array3i aabb_max_;
};
